...
class RightPanel(ctk.CTkFrame):
    ...
    def create_panel(self):
        ...
        # Свойства объекта
        self.obj_frame = ctk.CTkFrame(self, fg_color="#d0d0d0")

        ctk.CTkLabel(
            self.obj_frame, text="🎯 Свойства объекта:",
        ...
        # Размер
        ctk.CTkLabel(
            self.obj_frame, text="Размер:",
            fg_color="#d0d0d0", text_color="black",
            font=("Arial", 10)
        ).pack(anchor="w", padx=15)

        tk.Scale(
            self.obj_frame, from_=5, to=100,
        ...
        # Масса
        ctk.CTkLabel(
            self.obj_frame, text="Масса:",
            fg_color="#d0d0d0", text_color="black",
            font=("Arial", 10)
        ).pack(anchor="w", padx=15, pady=(5, 0))

        tk.Scale(
            self.obj_frame, from_=0.1, to=10, resolution=0.1,
        ...
        # Упругость
        ctk.CTkLabel(
            self.obj_frame, text="Упругость:",
            fg_color="#d0d0d0", text_color="black",
            font=("Arial", 10)
        ).pack(anchor="w", padx=15, pady=(5, 0))

        tk.Scale(
            self.obj_frame, from_=0, to=1, resolution=0.1,
        ...
        # Цвет
        ctk.CTkLabel(
            self.obj_frame, text="Цвет:",
            fg_color="#d0d0d0", text_color="black",
            font=("Arial", 10)
        ).pack(anchor="w", padx=15, pady=(5, 0))

        color_frame = ctk.CTkFrame(self.obj_frame, fg_color="#d0d0d0")
    ...
    def update_properties(self, obj):
        ...
        if obj:
            ...
            self.obj_frame.pack(fill="x", padx=10, pady=10)
        else:
            self.obj_frame.pack_forget()
